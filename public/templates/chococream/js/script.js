...
function changeActiveMenu(menu) {
    ...
    (menu);
    if (menu === "home") {
        $('#home-button').css('background-color', 'rgb(120, 96, 78)'); //active
        ...
        $('.title-icon-bride').css('color', '#a38263');
        $('.title-icon-event').css('color', '#a38263');
        $('.title-icon-location').css('color', '#a38263');
        $('.title-icon-menu').css('color', '#a38263');

    } else if (menu === "bride") {
        $('#home-button').css('background-color', 'transparent');
        $('#bride-button').css('background-color', 'rgb(120, 96, 78)'); //active
        $('#event-button').css('background-color', 'transparent');
        $('#location-button').css('background-color', 'transparent');
        $('#menu-button').css('background-color', 'transparent');

        $('.title-icon-home').css('color', '#a38263');
        ...
        $('#home-button').css('background-color', 'transparent');
        $('#bride-button').css('background-color', 'transparent');
        $('#event-button').css('background-color', 'rgb(120, 96, 78)'); //active
        $('#location-button').css('background-color', 'transparent');
        $('#menu-button').css('background-color', 'transparent');
        ...
        $('#bride-button').css('background-color', 'transparent');
        $('#event-button').css('background-color', 'transparent');
        $('#location-button').css('background-color', 'rgb(120, 96, 78)'); //active
        $('#menu-button').css('background-color', 'transparent');
        ...
        $('#event-button').css('background-color', 'transparent');
        $('#location-button').css('background-color', 'transparent');
        $('#menu-button').css('background-color', 'rgb(120, 96, 78)'); //active
