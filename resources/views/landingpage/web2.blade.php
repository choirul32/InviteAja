...
<section id="home">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/web/chococream/1-chococream.jpg" width="100" height="200" alt="Responsive image">
    </div>
    <div class="carousel-item">
      <img src="img/web/chococream/2-chococream.jpg" width="100" height="200" alt="Responsive image">
    </div>
    <div class="carousel-item">
      <img src="img/web/chococream/3-chococream.jpg" width="100" height="200" alt="Responsive image">
    </div>
    <div class="carousel-item">
      <img src="img/web/chococream/4-chococream.jpg" width="100" height="200" alt="Responsive image">
    </div>
    <div class="carousel-item">
      <img src="img/web/chococream/5-chococream.jpg" width="100" height="200" alt="Responsive image">
    </div>
    <div class="carousel-item">
      <img src="img/web/chococream/6-chococream.jpg" width="100" height="200" alt="Responsive image">
    </div>
    <div class="carousel-item">
      <img src="img/web/chococream/7-chococream.jpg" width="100" height="200" alt="Responsive image">
    </div>
    <div class="carousel-item">
      <img src="img/web/chococream/8-chococream.jpg" width="100" height="200" alt="Responsive image">
    </div>
  </div>
  ...
  <a class="carousel-control-next" href="#demo" data-slide="next">
    <span class="carousel-control-next-icon"></span>
      ...
      <div class="banner-home-right col-sm-5 col-xs-12 text-justify">
        <h1 class="banner-primary"><b>Choco Cream</b></h1>
