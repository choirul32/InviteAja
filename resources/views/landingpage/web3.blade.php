...
<section id="home">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/web/oreocream/1-oreocream.jpg" width="100" height="200" alt="Responsive image">
    </div>
    <div class="carousel-item">
      <img src="img/web/oreocream/2-oreocream.jpg" width="100" height="200" alt="Responsive image">
    </div>
    <div class="carousel-item">
      <img src="img/web/oreocream/3-oreocream.jpg" width="100" height="200" alt="Responsive image">
    </div>
    <div class="carousel-item">
      <img src="img/web/oreocream/4-oreocream.jpg" width="100" height="200" alt="Responsive image">
    </div>
    <div class="carousel-item">
      <img src="img/web/oreocream/5-oreocream.jpg" width="100" height="200" alt="Responsive image">
    </div>
    <div class="carousel-item">
      <img src="img/web/oreocream/6-oreocream.jpg" width="100" height="200" alt="Responsive image">
    </div>
    <div class="carousel-item">
      <img src="img/web/oreocream/7-oreocream.jpg" width="100" height="200" alt="Responsive image">
    </div>
    <div class="carousel-item">
      <img src="img/web/oreocream/8-oreocream.jpg" width="100" height="200" alt="Responsive image">
    </div>
  </div>
  ...
  <a class="carousel-control-next" href="#demo" data-slide="next">
    <span class="carousel-control-next-icon"></span>
      ...
      <div class="banner-home-right col-sm-5 col-xs-12 text-justify">
        <h1 class="banner-primary"><b>Oreo Cream</b></h1>
        <h2 class="menu-charga-detail"><b>Rp. 200.000</b></h2>
        <h1 class="banner-secondary"><b>Rp. 150.000</h1>
        <div class="tombolpro">
         ...
         <div  style="padding:20px 0">
               <ul class="fa-ul" style="font-size: 15px;text-align: left;">
                  ...
                  <li style="padding-bottom: 10px"><span class="fa-li"><i class="fa fa-check"></i></span><b>Halaman Pengantin</b></li>
                  <li style="padding-bottom: 10px"><span class="fa-li"><i class="fa fa-check"></i></span><b>Informasi Acara</b></li>
                  <li style="padding-bottom: 10px"><span class="fa-li"><i class="fa fa-check"></i></span><b>Denah Lokasi dan Google Maps Link</b></li>
                  <li style="padding-bottom: 10px"><span class="fa-li"><i class="fa fa-check"></i></span><b>Ruang Komentar dan Harapan</b></li>
                  <li style="padding-bottom: 10px"><span class="fa-li"><i class="fa fa-check"></i></span><b>Space Galeri Foto</b></li>
                  <li style="padding-bottom: 10px"><span class="fa-li"><i class="fa fa-check"></i></span><b>Kata Mutiara, Do'a, dan Harapan</b></li>
                  <li><span class="fa-li"><i class="fa fa-check"></i></span><b>Masa Aktif 1 Tahun</b></li>
                </ul>
              </div>
              ...
              <div class="card mb-5 mb-lg-0">
                <div class="card-body">
                  ...
                  <ul class="fa-ul">
                      ...
                      <li class="menu-pilihan">Mobil Web Invitation</li>
                    </ul>
                  <hr>
