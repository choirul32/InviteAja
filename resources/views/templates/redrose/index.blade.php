...
<head>
    ...
    <!-- InviteAja Style CSS -->
    <link rel="stylesheet" type="text/css" href="{{asset('templates/redrose/css/style.css')}}">
    <!-- Lightbox CSS -->
    <link rel="stylesheet" type="text/css" href="{{asset('templates/redrose/css/lightbox.min.css')}}">
...
<body>
    ...
    <script src="{{asset('templates/redrose/js/script.js')}}"></script>
    <!-- Lightbox JS -->
    <script src="{{asset('templates/redrose/js/lightbox-plus-jquery.min.js')}}"></script>

    <script>
    
        // LOAD HOME AS DEFAULT
        $("#content-ajax").load('{{url("/wedding/$permalink/redrose/home")}}');
        ...
        $("#bride-button").click(function() {
            $("#content-ajax").load('{{url("/wedding/$permalink/redrose/bride")}}');
    
        });
    
        $("#event-button").click(function() {
            $("#content-ajax").load('{{url("/wedding/$permalink/redrose/event")}}');
    
        });
    
        $("#location-button").click(function() {
            $("#content-ajax").load('{{url("/wedding/$permalink/redrose/location")}}');
    
        });
    
        $("#comment-button").click(function() {
            $("#content-ajax").load('{{url("/wedding/$permalink/redrose/comment")}}');
            modal.style.display = "none";
        });
    
        $("#gallery-button").click(function() {
            $("#content-ajax").load('{{url("/wedding/$permalink/redrose/gallery")}}');
            modal.style.display = "none";
        });
    
        $("#quotes-button").click(function() {
            $("#content-ajax").load('{{url("/wedding/$permalink/redrose/quotes")}}');
            modal.style.display = "none";
