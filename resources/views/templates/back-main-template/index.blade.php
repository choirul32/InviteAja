...
<head>
    ...
    <!-- Lightbox CSS -->
    <link rel="stylesheet" type="text/css" href="{{asset('templates/'.$data->name.'/css/lightbox.min.css')}}">
...
<body style="background-image: url({{ asset('/templates/'.$data->name.'/images/background.png') }} );">
    <!-- style="background-image: url(../templates/oreocream/images/background.png);" -->
    <!-- <div class="content-background">s</div> -->

    <div class="container" style="background-image: url({{ asset('/templates/'.$data->name.'/images/bgcanvas.jpg') }} );">
        <div id="content-ajax">
        </div>
        <!-- ===== NAVIGATION ===== -->
        ...
        <nav id="navbar" class="navbar-bottom text-center">
            ...
            <div id="location-button">
                <div class="navbar-icon-location" style="background-image: url({{ asset('/templates/'.$data->name.'/icons/location-icon.png') }} );"></div>
                <div class="clear-both"></div>
    ...
    <!-- Lightbox JS -->
    <script src="{{asset('templates/'.$data->name.'/js/lightbox-plus-jquery.min.js')}}"></script>
