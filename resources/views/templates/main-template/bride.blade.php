...
<section id="bride" class="bride border-helper">
    ...
    <div class="bride-intro">
        <div>
            <span>Assalamu`alaikum Warahmatullahi wabarakatuh</span><br>
            <span>Bismillaahirrahmanirrahim</span><br>
        </div>
        <div class="mt-4">
            <span>
                Dengan memohon rahmat dan ridho allah swt. <br>
                Kami Bermaksud mengundang bapak/ibu/saudara/i manghadiri <br>
